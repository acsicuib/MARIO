...
def main(simulated_time, path,pathResults,case,it):
    ...
    appOp = Mario(period=200)
    s.deploy_monitor("App-Operator", appOp, dStart,**{"sim": s, "routing": selectorPath, "pathCSV":default_results_path})
...
if __name__ == '__main__':
    ...
    pathExperimento = "scenarios/prototype1/"
    ...
    for i in range(nSimulations):
        ...
        random.seed(i)
        np.random.seed(i)
        logging.info("Running multi-agent-policies - %s" %pathExperimento)
