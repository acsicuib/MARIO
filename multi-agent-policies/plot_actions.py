...
def showActionsbyGroup(ncase,num,groupname,df0,dfmov0,pathcommon):
...
def run(datestamp):
    ...
    for item in experiments:
        ...
        try:
            ...
            showActionsbyGroup(ncase,1,"WS",df0, dfmov0,pathcommon)
            showActionsbyGroup(ncase,2,"LS", df1, dfmov1,pathcommon)

        except:
            print("Some error in plot action -move "+ncase)
